...
[_QWERTY] = LAYOUT(
  ...
  CTL_ESC,  KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,     KC_L,    LT_MC(KC_SCLN), KC_QUOT, KC_P4,   KC_P5,   KC_P6, \
  KC_LSFT,  KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,  KC_SLSH,        CTL_ENT, KC_P1,   KC_P2,   KC_P3, \
  KC_GRV,   KC_LCTRL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  LT(_RAISE, KC_BSPC),  KC_LEFT,  KC_DOWN, KC_UP,          KC_RGHT, KC_P0,   KC_DOT,  KC_EQL \
),
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,   KC_LBRC, KC_RBRC, KC_PIPE, _______, _______, _______, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS),_______, _______, _______, _______, _______, _______, \
...
[_RAISE] = LAYOUT(
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LCBR,  KC_RCBR, KC_BSLS, _______, _______, _______, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, _______,  _______, _______, _______, _______, _______,
 ...
 */
[_ADJUST] = LAYOUT(
  RESET,   HPT_TOG, HPT_FBK, HPT_MODI, HPT_MODD, HPT_RST , HPT_CONT, HPT_CONI, HPT_COND, _______, _______, EEP_RST, \
  _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, KC_DEL, \
  _______, _______, _______, AU_ON,   AU_OFF,  AG_NORM, _______, _______, _______, AG_SWAP, QWERTY,  _______, _______,  _______,  _______, \
