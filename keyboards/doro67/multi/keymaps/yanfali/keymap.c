...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_multi(
    KC_GRV,           KC_1,    KC_2,    KC_3,    KC_4,           KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_NO,   KC_INS,
    ...
    KC_LCTL,          KC_LALT, KC_LGUI, KC_SPC,  LT(1, KC_SPC),  KC_BSPC, KC_RALT, KC_RGUI, MO(1),                                       KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_multi(
