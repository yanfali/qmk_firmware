...
[FN] = LAYOUT_65_ansi( /* FN */
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______,          KC_HOME, _______,\
    _______, _______, _______,                _______,                               _______, _______, _______, KC_INS,  KC_END,  KC_DEL)
};
