...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_MEDIA] = ACTION_TAP_DANCE_DOUBLE(KC_MPLY, KC_MFFD)
};
...
[_RAISE] = LAYOUT( \
  ...
  KC_ESC, KC_CAPS, KC_LALT, KC_LCTL, LOWER, KC_SPC, KC_SPC, _______, TD(TD_MEDIA), KC_VOLD, KC_VOLU, KC_MPLY \
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, TD_MEDIA, KC_VOLD, KC_VOLU, KC_MPLY \
),
