...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, LT(_FN1, KC_SPC),                    KC_BSPC, MO(_FN1), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    AU_TOG,  CK_TOGG, MU_TOG,  MU_MOD,  _______,                   _______, _______, _______, _______, _______, _______
  )
};
