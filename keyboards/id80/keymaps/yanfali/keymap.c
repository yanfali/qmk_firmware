...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,             KC_F1,   KC_F2,   KC_F3,   KC_F4,     KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, LT(1, KC_NUMLOCK),     KC_DEL,
    ...
    [1] = LAYOUT(
        RESET,    _______, _______, _______, _______,   _______, _______, _______, _______,   _______, _______, _______, EEP_RST,    _______,   KC_MUTE,
        ...
        _______,  _______, _______, BL_DEC,  BL_TOGG, BL_INC,  NK_TOGG, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS,         BL_INC,
