...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = KEYMAP(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RALT, KC_RGUI, MO(_FL), KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_FL] = KEYMAP(
        ...
        _______, KC_MS_BTN1, KC_MS_UP,   KC_MS_BTN2,  _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,        KC_MS_BTN1, _______,    KC_MS_BTN2,  \
