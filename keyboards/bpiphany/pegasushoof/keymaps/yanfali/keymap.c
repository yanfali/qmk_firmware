...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[KM_QWERTY] = LAYOUT( \
		...
		KC_LCTL, KC_LALT,KC_LGUI,                       KC_SPC,                          KC_RALT,KC_RGUI,KC_FN0,KC_RCTL,   KC_LEFT,KC_DOWN,KC_RGHT),
	...
	[KM_MEDIA] = LAYOUT( \
		...
		_______,_______,_______,                        _______,                        _______,_______,KC_FN0 ,_______,   KC_MPRV,KC_MSTP,KC_MNXT)
};
